...
public class LDLTPermutedFactorization {
	...
	public LDLTPermutedFactorization(DoubleMatrix2D Q, IMatrixRescaler rescaler) throws JOptimizerException {
		this(Q, DIAGONAL_PIVOLTING_WITH_PARTIAL_PIVOTING, rescaler);
	}
	
	public LDLTPermutedFactorization(DoubleMatrix2D Q, int mode, IMatrixRescaler rescaler) throws JOptimizerException {
		this.dim = Q.rows();
		this.Q = Q;
		this.mode = mode;
