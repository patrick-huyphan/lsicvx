...
public class QRSparseFactorization {
	...
	private int order;
	private IMatrixRescaler rescaler = null;
	...
	public QRSparseFactorization(SparseDoubleMatrix2D A, IMatrixRescaler rescaler) throws JOptimizerException {
		this(A, 0, rescaler);
	}
	 ...
	 */
	public QRSparseFactorization(SparseDoubleMatrix2D A, int order, IMatrixRescaler rescaler) throws JOptimizerException {
		if (order < 0 || order > 3) {
