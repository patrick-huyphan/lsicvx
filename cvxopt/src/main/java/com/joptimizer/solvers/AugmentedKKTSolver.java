...
import com.joptimizer.algebra.IMatrixRescaler;
...
//		});
		...
		CholeskyFactorization HFact = new CholeskyFactorization(HAugm, (IMatrixRescaler) new Matrix1NormRescaler());
		try {
			HFact.factorize();
		...
		CholeskyFactorization MSFact = new CholeskyFactorization(MenoSLower, (IMatrixRescaler) new Matrix1NormRescaler());
		MSFact.factorize();
		if (h == null) {
