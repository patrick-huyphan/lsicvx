 ...
 */
public class LogarithmicBarrier implements IBarrierFunction {
	...
	private IConvexMultivariateRealFunction[] fi = null;
	private int dim = -1;
	 ...
	 * @see "S.Boyd and L.Vandenberghe, Convex Optimization, 11.2.1"
	 */
	public LogarithmicBarrier(IConvexMultivariateRealFunction[] fi, int dim) {
		this.fi = fi;
		this.dim = dim;
	}
	 ...
	 * <br>fi(X)-s, i=1,...,n
	 */
	public IBarrierFunction createPhase1BarrierFunction(){
		
		final int dimPh1 = dim +1;
		IConvexMultivariateRealFunction[] inequalitiesPh1 = new IConvexMultivariateRealFunction[this.fi.length];
		for(int i=0; i<inequalitiesPh1.length; i++){
			
			final IConvexMultivariateRealFunction originalFi = this.fi[i];
			
			IConvexMultivariateRealFunction fi = new IConvexMultivariateRealFunction() {
		...
		IBarrierFunction bfPh1 = new LogarithmicBarrier(inequalitiesPh1, dimPh1);
		return bfPh1;
	}
