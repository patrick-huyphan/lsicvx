...
public class OptimizationRequest {
	 ...
	 * Mandatory.
	 */
	private IConvexMultivariateRealFunction f0;
	 ...
	 * @see "Convex Optimization, 11.1"
	 */
	private IConvexMultivariateRealFunction[] fi;
	...
	public IConvexMultivariateRealFunction getF0() {
		return f0;
	}

	public void setF0(IConvexMultivariateRealFunction f0) {
		this.f0 = f0;
	}
	...
	public IConvexMultivariateRealFunction[] getFi() {
		return fi;
	}

	public void setFi(IConvexMultivariateRealFunction[] fi) {
		this.fi = fi;
	}
