...
public class BarrierMethod extends IOptimizationRequestHandler {
	...
	public BarrierMethod(IBarrierFunction barrierFunction) {
...
//		}
		...
		while (true) {
			...
			IConvexMultivariateRealFunction newObjectiveFunction = new IConvexMultivariateRealFunction() {
...
//			}
	...
	protected IBarrierFunction getBarrierFunction(){
