...
public class ASCC extends Clustering {
...
//    boolean stop = false;
     ...
     * @throws IOException
     */
    public ASCC(double[][] _Matrix, double _lambda, double _lambda2, double _rho, double _e1, double _e2, boolean hl,int maxloop, double t, boolean logSave, int stepSave,String output) throws IOException, Exception {
...
//            logData(loop, fw, U, V);          
            ...
            {
                System.out.println(" ASCC 3 STOP at " + loop);
//                getPath(V);A
                break;
            }
            else{
                System.out.println(" ASCC 3 update 2 at " + loop);
...
//Test
    System.out.println("paper.SCC.getCluster() " + cluster.size());
      try {
            ...
            Logger.getLogger(ASCC.class.getName()).log(Level.SEVERE, null, ex);
        }
